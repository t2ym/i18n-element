...
Polymer({
   ...
   */
  ready: function () {
    if (this.persist) {// delay this.lang update
  ...
  attached: function () {
    ...
    if (this.persist) {// delay html.lang update
    } else {
  ...
  _onLoadEmptyStorage: function () {
    if (this.isReady) {
      ...
      } else {// leave the empty storage as it is
      }
    }
  },
  ...
  _observe: function () {
    ...
    if (!this._htmlLangMutationObserver) {
      this._htmlLangMutationObserverCallbackBindThis = this._htmlLangMutationObserverCallback.bind(this);
      this._htmlLangMutationObserver = new MutationObserver(this._htmlLangMutationObserverCallbackBindThis);
    }
