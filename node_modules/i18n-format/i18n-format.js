...
Polymer({
  ...
  _setupParams: function () {
    var n;
    this.elements = Array.prototype.filter.call(dom(this).childNodes, function (node) {
      return node.nodeType === node.ELEMENT_NODE;
    });
    var needParamObservation = this.observeParams && this.elements.length > 0 && this.elements[0].tagName.toLowerCase() === 'json-data';
    ...
    for (n = 0; n < this.elements.length; n++) {
      if (n === 0) {
        ...
        this.observer.observe(this.templateTextNode, {
          characterData: true
        });
      } else {
        ...
        if (needParamObservation) {
          ...
          this.observer.observe(dom(this.elements[n]).childNodes[0], {
            characterData: true
          });
    ...
    mutations.forEach(function (mutation) {
      switch (mutation.type) {
        case 'characterData':
          ...
          if (mutation.target.parentNode.tagName.toLowerCase() !== 'i18n-number' || typeof mutation.target.parentNode.formatted !== 'undefined') {
            this.render();
          }
  ...
  /*, oldLang */
    ...
    if (this.elements && lang !== undefined && lang !== null && !lang.match(/^{{.*}}$/) && !lang.match(/^\[\[.*\]\]$/)) {
      this.render();
    } //else {
  ...
  _paramFormatChanged: function (paramFormat, oldParamFormat) {
    ...
    if (this.elements && oldParamFormat !== undefined && paramFormat && this.lang !== undefined && this.lang !== null && !this.lang.match(/^{{.*}}$/) && !this.lang.match(/^\[\[.*\]\]$/)) {
  ...
  */
  ...
  _selectTemplateText: function () {
    ...
    if (!this.templateElement) {
      ...
      for (n = 1; typeof templateObject === 'object' && n < this.elements.length; n++) {
        ...
        if (param.tagName.toLowerCase() === 'i18n-number') {
          ...
          if (typeof param.number === 'undefined' || typeof param.formatted === 'undefined') {
  ...
  render: function () {
    ...
    if (templateText === this.lastTemplateText) {
      ...
      this.lastTemplateText = templateText; //console.log('i18n-format: ' + this.id + '.render() templateText = ' + templateText);
    }
