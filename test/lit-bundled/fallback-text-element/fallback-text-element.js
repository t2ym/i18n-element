...
$_documentContainer.innerHTML = `<template id="fallback-text-element">
...
case 'element-binding': {
    class FallbackTextElement extends i18n(HTMLElement) {
    ...
    class FallbackTextElement extends i18n(HTMLElement) {
      ...
      render() {
        return html([
          ...
          '</code></i18n-format></p>',
          ''
        ], ...bind('fallback-text-element', import.meta, (_bind, text, model, effectiveLang) => [
          _bind,
          text['text'],
          text['h1_3'],
          text['text_4'],
    ...
    class FallbackTextElement extends i18n(HTMLElement) {
      ...
      render() {
        return html([
          ...
          '</code></i18n-format></p>',
          ''
        ], ...bind(this, 'fallback-text-element', (_bind, text, model, effectiveLang) => [
          _bind,
          text['text'],
          text['h1_3'],
          text['text_4'],
