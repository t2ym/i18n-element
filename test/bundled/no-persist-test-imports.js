...
});});}(params.setup?teardown:suiteTeardown)(function(){restoreFixture(params.fixture);});});});};const bundledImportMeta$7={...import.meta,url:new URL('./preference/preference-element.js',import.meta.url).href};const $_documentContainer$3=document.createElement('template');$_documentContainer$3.innerHTML=`<template id="preference-element">
    <span id="oldLang"></span>
  </template>`;document.head.appendChild($_documentContainer$3.content);switch(syntax){default:case'mixin':{class PreferenceElement extends Mixins.Localizable(LegacyElementMixin(HTMLElement)){static get importMeta(){return bundledImportMeta$7;}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t;})(html`
    <span id="oldLang"></span>
<template id="localizable-text">
<json-data>
{
