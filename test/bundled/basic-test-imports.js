...
</template><div id="dom-module-placeholder"></div>`;(function(document){"use strict";var html=document.querySelector("html"),defaultLang=html.hasAttribute("lang")?html.getAttribute("lang"):"",template=$_documentContainer$1.content.querySelector("template#i18n-preference"),domModule=document.createElement("dom-module"),registerI18nPreference=function(){domModule.appendChild(template);domModule.register("i18n-preference");Polymer$1({importMeta:bundledImportMeta$5,is:"i18n-preference",properties:{persist:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0,observer:"_onPersistChange"}},ready:function(){if(this.persist){}else{}this.isReady=!0},attached:function(){this._observe();if(this.persist){}else{if(!html.hasAttribute("preferred")){html.setAttribute("lang",navigator.language||navigator.browserLanguage)}}},detached:function(){this._disconnect()},_onLoadEmptyStorage:function(){if(this.isReady){if(this.persist){if(this.isInitialized){this.$.storage.value=html.getAttribute("lang")}else{if(html.hasAttribute("preferred")){this.$.storage.value=html.getAttribute("lang")}else{this.$.storage.value=navigator.language||navigator.browserLanguage;if(html.getAttribute("lang")!==this.$.storage.value){html.setAttribute("lang",this.$.storage.value)}}this.isInitialized=!0}}else{}}},_onLoadStorage:function(){if(this.isReady){if(this.persist){if(html.hasAttribute("preferred")){if(this.$.storage.value!==defaultLang){this.$.storage.value=defaultLang}}else{html.setAttribute("lang",this.$.storage.value)}}else{this.$.storage.value=void 0}}},_onPersistChange:function(value){if(this.isReady){if(value){if(this.$.storage.value!==html.getAttribute("lang")){this.$.storage.value=html.getAttribute("lang")}}else{this.$.storage.value=void 0}}},_onStorageValueChange:function(e){var value=e.detail.value;if(this.isReady){if(this.persist){if(value){if(value!==html.getAttribute("lang")){html.setAttribute("lang",value)}}else{this.$.storage.value=html.getAttribute("lang")}}else{if(value){this.$.storage.value=void 0}}}},_htmlLangMutationObserverCallback:function(mutations){mutations.forEach(function(mutation){switch(mutation.type){case"attributes":if("lang"===mutation.attributeName){if(this.$.storage.value!==mutation.target.getAttribute("lang")){this.$.storage.value=mutation.target.getAttribute("lang")}}break;default:break;}}.bind(this))},_observe:function(){if(!this._htmlLangMutationObserver){this._htmlLangMutationObserverCallbackBindThis=this._htmlLangMutationObserverCallback.bind(this);this._htmlLangMutationObserver=new MutationObserver(this._htmlLangMutationObserverCallbackBindThis)}this._htmlLangMutationObserver.observe(html,{attributes:!0})},_disconnect:function(){if(this._htmlLangMutationObserver){this._htmlLangMutationObserver.disconnect()}}})};if(!window.HTMLImports||HTMLImports.hasNative||HTMLImports.useNative){registerI18nPreference()}else{HTMLImports.whenReady(registerI18nPreference)}})(document);const bundledImportMeta$6={...import.meta,url:new URL("../../node_modules/i18n-behavior/i18n-attr-repo.js",import.meta.url).href},$_documentContainer$2=document.createElement("template");$_documentContainer$2.innerHTML=`<template id="i18n-attr-repo">
...
`),is:"simple-text-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(e){console.log(this.is,"lang-updated",e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}}})}break;}const bundledImportMeta$8={...import.meta,url:new URL("./commented-simple-text-element/commented-simple-text-element.js",import.meta.url).href},$_documentContainer$4=document.createElement("template");$_documentContainer$4.innerHTML=`<template id="commented-simple-text-element"><!-- comment -->
  ...
  </template>`;document.head.appendChild($_documentContainer$4.content);switch(syntax){default:case"mixin":{class CommentedSimpleTextElement extends Mixins.Localizable(LegacyElementMixin(HTMLElement)){static get importMeta(){return bundledImportMeta$8}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t})(html`
...
`),is:"commented-simple-text-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(e){console.log(this.is,"lang-updated",e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}}})}break;}const bundledImportMeta$9={...import.meta,url:new URL("./plural-gender-element/plural-gender-element.js",import.meta.url).href},$_documentContainer$5=document.createElement("template");$_documentContainer$5.innerHTML=`<template id="plural-gender-element">
    <p>
  ...
  </template>`;document.head.appendChild($_documentContainer$5.content);switch(syntax){default:case"mixin":{class PluralGenderElement extends Mixins.Localizable(LegacyElementMixin(HTMLElement)){static get importMeta(){return bundledImportMeta$9}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t})(html`
    <p>
...
<template id="text-attribute-element">
  ...
  <span>text</span>
</template>`;document.head.appendChild($_documentContainer$6.content);switch(syntax){default:case"mixin":{class TextAttributeElement extends Mixins.Localizable(LegacyElementMixin(HTMLElement)){static get importMeta(){return bundledImportMeta$a}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t})(html`
    <span id="attr1">{{customTextAttr1}}</span>
    <span id="attr2">{{customTextAttr2}}</span>
    <span id="attr3">{{customTextAttr3}}</span>
    <span id="attr4">{{outOfScopeAttr}}</span>
...
`),is:"simple-attribute-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated","pie-chart.google-chart-render":"_pieChartRendered","column-chart.google-chart-render":"_columnChartRendered"},ready:function(){},attached:function(){this._intervalId=window.setInterval(this._checkChartStatus.bind(this),1e3);setTimeout(function(){this.isPieChartRendered=!0;this.isColumnChartRendered=!0;window.clearInterval(this._intervalId);this.fire("local-dom-ready")}.bind(this),200)},_checkChartStatus:function(){var pieChartInnerHtml=this.$["pie-chart"].$.chartdiv.innerHTML,columnChartInnerHtml=this.$["column-chart"].$.chartdiv.innerHTML,notLoaded=!1;if("Undefined chart type"===pieChartInnerHtml){this.isPieChartRendered=!0}if("Undefined chart type"===columnChartInnerHtml){this.isColumnChartRendered=!0}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}},_langUpdated:function(e){if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}},_pieChartRendered:function(){this.isPieChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}},_columnChartRendered:function(){this.isColumnChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}})}break;}const bundledImportMeta$c={...import.meta,url:new URL("./fallback-text-element/fallback-text-element.js",import.meta.url).href},$_documentContainer$8=document.createElement("template");$_documentContainer$8.innerHTML=`<template id="fallback-text-element">
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
  </template>`;document.head.appendChild($_documentContainer$8.content);switch(syntax){default:case"mixin":{class FallbackTextElement extends Mixins.Localizable(LegacyElementMixin(HTMLElement)){static get importMeta(){return bundledImportMeta$c}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t})(html`{{text.text}}<div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>{{text.h1_3}}</h1>{{text.text_4}}<span>{{text.span_5}}</span>
    <span>{{text.span_6}}</span>
    <span id="label-1">{{text.label-1}}</span>
...
`),is:"fallback-text-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(e){console.log(this.is,"lang-updated",e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}}})}break;}const bundledImportMeta$d={...import.meta,url:new URL("./compound-binding-element/compound-binding-element.js",import.meta.url).href},$_documentContainer$9=document.createElement("template");$_documentContainer$9.innerHTML=`<template id="compound-binding-element">
  ...
  </template>`;document.head.appendChild($_documentContainer$9.content);switch(syntax){default:case"mixin":{class CompoundBindingElement extends Mixins.Localizable(LegacyElementMixin(HTMLElement)){static get importMeta(){return bundledImportMeta$d}static get template(){return(t=>{t.setAttribute("localizable-text","embedded");return t})(html`<i18n-format lang="{{effectiveLang}}"><span>{{text.text.0}}</span><span slot="1">{{param1}}</span><span slot="2">{{param2}}</span></i18n-format><div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
