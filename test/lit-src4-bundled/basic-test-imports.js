...
</template><div id="dom-module-placeholder"></div>`;var html$2=document.querySelector("html"),defaultLang=html$2.hasAttribute("lang")?html$2.getAttribute("lang"):"",template$1=$_documentContainer.content.querySelector("template#i18n-preference"),domModule$1=document.createElement("dom-module");domModule$1.appendChild(template$1);domModule$1.register("i18n-preference");Polymer$1({importMeta:bundledImportMeta$4,is:"i18n-preference",properties:{persist:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0,observer:"_onPersistChange"}},ready:function(){if(this.persist){}else{}this.isReady=!0},attached:function(){this._observe();if(this.persist){}else{if(!html$2.hasAttribute("preferred")){html$2.setAttribute("lang",navigator.language||navigator.browserLanguage)}}},detached:function(){this._disconnect()},_onLoadEmptyStorage:function(){if(this.isReady){if(this.persist){if(this.isInitialized){this.$.storage.value=html$2.getAttribute("lang")}else{if(html$2.hasAttribute("preferred")){this.$.storage.value=html$2.getAttribute("lang")}else{this.$.storage.value=navigator.language||navigator.browserLanguage;if(html$2.getAttribute("lang")!==this.$.storage.value){html$2.setAttribute("lang",this.$.storage.value)}}this.isInitialized=!0}}else{}}},_onLoadStorage:function(){if(this.isReady){if(this.persist){if(html$2.hasAttribute("preferred")){if(this.$.storage.value!==defaultLang){this.$.storage.value=defaultLang}}else{html$2.setAttribute("lang",this.$.storage.value)}}else{this.$.storage.value=void 0}}},_onPersistChange:function(value){if(this.isReady){if(value){if(this.$.storage.value!==html$2.getAttribute("lang")){this.$.storage.value=html$2.getAttribute("lang")}}else{this.$.storage.value=void 0}}},_onStorageValueChange:function(e){var value=e.detail.value;if(this.isReady){if(this.persist){if(value){if(value!==html$2.getAttribute("lang")){html$2.setAttribute("lang",value)}}else{this.$.storage.value=html$2.getAttribute("lang")}}else{if(value){this.$.storage.value=void 0}}}},_htmlLangMutationObserverCallback:function(mutations){mutations.forEach(function(mutation){switch(mutation.type){case"attributes":if("lang"===mutation.attributeName){if(this.$.storage.value!==mutation.target.getAttribute("lang")){this.$.storage.value=mutation.target.getAttribute("lang")}}break;default:break;}}.bind(this))},_observe:function(){if(!this._htmlLangMutationObserver){this._htmlLangMutationObserverCallbackBindThis=this._htmlLangMutationObserverCallback.bind(this);this._htmlLangMutationObserver=new MutationObserver(this._htmlLangMutationObserverCallbackBindThis)}this._htmlLangMutationObserver.observe(html$2,{attributes:!0})},_disconnect:function(){if(this._htmlLangMutationObserver){this._htmlLangMutationObserver.disconnect()}}});const bundledImportMeta$5={...import.meta,url:new URL("../../node_modules/i18n-behavior/i18n-attr-repo.js",import.meta.url).href},$_documentContainer$1=document.createElement("template");$_documentContainer$1.innerHTML=`<template id="i18n-attr-repo">
...
</custom-style>`;template$4.setAttribute("style","display: none;");document.head.appendChild(template$4.content);Polymer$1({_template:html$1`
    <style>
      :host {
        display: inline-block;
        float: right;
...
`;template$5.setAttribute("style","display: none;");document.head.appendChild(template$5.content);const template$6=html$1`
<custom-style>
  <style is="custom-style">
    html {
      /*
...
</custom-style>`;template$6.setAttribute("style","display: none;");document.head.appendChild(template$6.content);const template$7=html$1`
<custom-style>
  <style is="custom-style">
    html {
...
`;template$7.setAttribute("style","display: none;");document.head.appendChild(template$7.content);Polymer$1({_template:html$1`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-input-container",properties:{noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},attrForValue:{type:String,value:"bind-value"},autoValidate:{type:Boolean,value:!1},invalid:{observer:"_invalidChanged",type:Boolean,value:!1},focused:{readOnly:!0,type:Boolean,value:!1,notify:!0},_addons:{type:Array},_inputHasContent:{type:Boolean,value:!1},_inputSelector:{type:String,value:"input,iron-input,textarea,.paper-input-input"},_boundOnFocus:{type:Function,value:function(){return this._onFocus.bind(this)}},_boundOnBlur:{type:Function,value:function(){return this._onBlur.bind(this)}},_boundOnInput:{type:Function,value:function(){return this._onInput.bind(this)}},_boundValueChanged:{type:Function,value:function(){return this._onValueChanged.bind(this)}}},listeners:{"addon-attached":"_onAddonAttached","iron-input-validate":"_onIronInputValidate"},get _valueChangedEvent(){return this.attrForValue+"-changed"},get _propertyForValue(){return dashToCamelCase(this.attrForValue)},get _inputElement(){return dom$2(this).querySelector(this._inputSelector)},get _inputElementValue(){return this._inputElement[this._propertyForValue]||this._inputElement.value},ready:function(){this.__isFirstValueUpdate=!0;if(!this._addons){this._addons=[]}this.addEventListener("focus",this._boundOnFocus,!0);this.addEventListener("blur",this._boundOnBlur,!0)},attached:function(){if(this.attrForValue){this._inputElement.addEventListener(this._valueChangedEvent,this._boundValueChanged)}else{this.addEventListener("input",this._onInput)}if(this._inputElementValue&&""!=this._inputElementValue){this._handleValueAndAutoValidate(this._inputElement)}else{this._handleValue(this._inputElement)}},_onAddonAttached:function(event){if(!this._addons){this._addons=[]}var target=event.target;if(-1===this._addons.indexOf(target)){this._addons.push(target);if(this.isAttached){this._handleValue(this._inputElement)}}},_onFocus:function(){this._setFocused(!0)},_onBlur:function(){this._setFocused(!1);this._handleValueAndAutoValidate(this._inputElement)},_onInput:function(event){this._handleValueAndAutoValidate(event.target)},_onValueChanged:function(event){var input=event.target;if(this.__isFirstValueUpdate){this.__isFirstValueUpdate=!1;if(input.value===void 0||""===input.value){return}}this._handleValueAndAutoValidate(event.target)},_handleValue:function(inputElement){var value=this._inputElementValue;if(value||0===value||"number"===inputElement.type&&!inputElement.checkValidity()){this._inputHasContent=!0}else{this._inputHasContent=!1}this.updateAddons({inputElement:inputElement,value:value,invalid:this.invalid})},_handleValueAndAutoValidate:function(inputElement){if(this.autoValidate&&inputElement){var valid;if(inputElement.validate){valid=inputElement.validate(this._inputElementValue)}else{valid=inputElement.checkValidity()}this.invalid=!valid}this._handleValue(inputElement)},_onIronInputValidate:function(event){this.invalid=this._inputElement.invalid},_invalidChanged:function(){if(this._addons){this.updateAddons({invalid:this.invalid})}},updateAddons:function(state){for(var addon,index=0;addon=this._addons[index];index++){addon.update(state)}},_computeInputContentClass:function(noLabelFloat,alwaysFloatLabel,focused,invalid,_inputHasContent){var cls="input-content";if(!noLabelFloat){var label=this.querySelector("label");if(alwaysFloatLabel||_inputHasContent){cls+=" label-is-floating";this.$.labelAndInputContainer.style.position="static";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" label-is-highlighted"}}else{if(label){this.$.labelAndInputContainer.style.position="relative"}if(invalid){cls+=" is-invalid"}}}else{if(_inputHasContent){cls+=" label-is-hidden"}if(invalid){cls+=" is-invalid"}}if(focused){cls+=" focused"}return cls},_computeUnderlineClass:function(focused,invalid){var cls="underline";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" is-highlighted"}return cls},_computeAddOnContentClass:function(focused,invalid){var cls="add-on-content";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" is-highlighted"}return cls}});Polymer$1({_template:html$1`
    ...
    <slot></slot>
`,is:"paper-input-error",behaviors:[PaperInputAddonBehavior],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(state){this._setInvalid(state.invalid)}});Polymer$1({is:"paper-input",_template:html$1`
    <style>
      :host {
        display: block;
      }
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_updateEffectiveLang(event){super._updateEffectiveLang(event);console.log(`${this.is}: _updateEffectiveLang effectiveLang="${this.effectiveLang}" lang="${this.lang}"`)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(SimpleTextElement.is,SimpleTextElement)}break;case"name-binding":{class SimpleTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$7}render(){return html$4`${bind("simple-text-element",bundledImportMeta$7)}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_updateEffectiveLang(event){super._updateEffectiveLang(event);console.log(`${this.is}: _updateEffectiveLang effectiveLang="${this.effectiveLang}" lang="${this.lang}"`)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(SimpleTextElement.is,SimpleTextElement)}break;case"element-name-binding":{class SimpleTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$7}render(){return html$4`${bind(this,"simple-text-element")}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_updateEffectiveLang(event){super._updateEffectiveLang(event);console.log(`${this.is}: _updateEffectiveLang effectiveLang="${this.effectiveLang}" lang="${this.lang}"`)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(SimpleTextElement.is,SimpleTextElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$7,_template:html$4`
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
...
`,is:"simple-text-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(e){console.log(this.is,"lang-updated",e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}}})}break;}const bundledImportMeta$8={...import.meta,url:new URL("./commented-simple-text-element/commented-simple-text-element.js",import.meta.url).href},$_documentContainer$3=document.createElement("template");$_documentContainer$3.innerHTML=`<template id="commented-simple-text-element"><!-- comment -->
  ...
  </template>`;switch(syntax){default:case"element-binding":{class CommentedSimpleTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$8}render(){return html$4`${bind(this)}
<!-- comment -->
    outermost text at the beginning <!-- comment -->
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; <!-- comment --></span><!-- comment -->
    ...
    <p id="paragraph"><!-- comment -->A paragraph with <!-- comment --><b>id</b><!-- comment --> is converted to <!-- comment --><code>&lt;i18n-format&gt;</code><!-- comment -->.<!-- comment --></p>
    outermost text at the end <!-- comment -->
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_updateEffectiveLang(event){super._updateEffectiveLang(event);console.log(`${this.is}: _updateEffectiveLang effectiveLang="${this.effectiveLang}" lang="${this.lang}" stack=${new Error().stack}`)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(CommentedSimpleTextElement.is,CommentedSimpleTextElement)}break;case"name-binding":{class CommentedSimpleTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$8}render(){return html$4`${bind("commented-simple-text-element",bundledImportMeta$8)}
<!-- comment -->
    outermost text at the beginning <!-- comment -->
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; <!-- comment --></span><!-- comment -->
    ...
    <p id="paragraph"><!-- comment -->A paragraph with <!-- comment --><b>id</b><!-- comment --> is converted to <!-- comment --><code>&lt;i18n-format&gt;</code><!-- comment -->.<!-- comment --></p>
    outermost text at the end <!-- comment -->
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_updateEffectiveLang(event){super._updateEffectiveLang(event);console.log(`${this.is}: _updateEffectiveLang effectiveLang="${this.effectiveLang}" lang="${this.lang}" stack=${new Error().stack}`)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(CommentedSimpleTextElement.is,CommentedSimpleTextElement)}break;case"element-name-binding":{class CommentedSimpleTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$8}render(){return html$4`${bind(this,"commented-simple-text-element")}
<!-- comment -->
    outermost text at the beginning <!-- comment -->
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; <!-- comment --></span><!-- comment -->
    ...
    <p id="paragraph"><!-- comment -->A paragraph with <!-- comment --><b>id</b><!-- comment --> is converted to <!-- comment --><code>&lt;i18n-format&gt;</code><!-- comment -->.<!-- comment --></p>
    outermost text at the end <!-- comment -->
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_updateEffectiveLang(event){super._updateEffectiveLang(event);console.log(`${this.is}: _updateEffectiveLang effectiveLang="${this.effectiveLang}" lang="${this.lang}" stack=${new Error().stack}`)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(CommentedSimpleTextElement.is,CommentedSimpleTextElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$8,_template:html$4`
<!-- comment -->
    outermost text at the beginning <!-- comment -->
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; <!-- comment --></span><!-- comment -->
...
`,is:"commented-simple-text-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(e){console.log(this.is,"lang-updated",e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}}})}break;}const bundledImportMeta$9={...import.meta,url:new URL("./plural-gender-element/plural-gender-element.js",import.meta.url).href},$_documentContainer$4=document.createElement("template");$_documentContainer$4.innerHTML=`<template id="plural-gender-element">
  ...
  </template>`;switch(syntax){default:case"element-binding":{class PluralGenderElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$9}render(){const recipientsLength=this.recipients?this.recipients.length:0,recipients0Gender=recipientsLength?this.recipients[0].gender:"",recipients0Name=recipientsLength?this.recipients[0].name:"",senderName=this.sender?this.sender.name:"";return html$4`${bind(this)}
    <p>
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}get sender(){return this._sender}set sender(value){this._sender=value;this.invalidate()}get recipients(){return this._recipients}set recipients(value){this._recipients=value;this.invalidate()}_langUpdated(e){console.log("plural-gender-element lang-updated lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(this.renderedEffectiveLang===this.effectiveLang||!this.renderedEffectiveLang&&"en"===this.effectiveLang){this.fire("local-dom-ready")}else{this.invalidate()}}_rendered(){console.log("plural-gender-element rendered lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(this.lang===this.effectiveLang){this.fire("local-dom-ready")}else{this.renderedEffectiveLang=this.effectiveLang;setTimeout(()=>{this.fire("local-dom-ready")},5e3)}}}customElements.define(PluralGenderElement.is,PluralGenderElement)}break;case"name-binding":{class PluralGenderElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$9}render(){const recipientsLength=this.recipients?this.recipients.length:0,recipients0Gender=recipientsLength?this.recipients[0].gender:"",recipients0Name=recipientsLength?this.recipients[0].name:"",senderName=this.sender?this.sender.name:"";return html$4`${bind("plural-gender-element",bundledImportMeta$9)}
    <p>
      <i18n-format id="compound-format-text" @rendered=${this._rendered.bind(this)}>
        <json-data>{
          "0": "You ({3}) gave no gifts.",
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}get sender(){return this._sender}set sender(value){this._sender=value;this.invalidate()}get recipients(){return this._recipients}set recipients(value){this._recipients=value;this.invalidate()}_langUpdated(e){console.log("plural-gender-element lang-updated lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(this.renderedEffectiveLang===this.effectiveLang||!this.renderedEffectiveLang&&"en"===this.effectiveLang){this.fire("local-dom-ready")}else{this.invalidate()}}_rendered(){console.log("plural-gender-element rendered lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(this.lang===this.effectiveLang){this.fire("local-dom-ready")}else{this.renderedEffectiveLang=this.effectiveLang;setTimeout(()=>{this.fire("local-dom-ready")},5e3)}}}customElements.define(PluralGenderElement.is,PluralGenderElement)}break;case"element-name-binding":{class PluralGenderElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$9}render(){const recipientsLength=this.recipients?this.recipients.length:0,recipients0Gender=recipientsLength?this.recipients[0].gender:"",recipients0Name=recipientsLength?this.recipients[0].name:"",senderName=this.sender?this.sender.name:"";return html$4`${bind(this,"plural-gender-element")}
    <p>
      <i18n-format id="compound-format-text" @rendered=${this._rendered.bind(this)}>
        <json-data>{
          "0": "You ({3}) gave no gifts.",
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}get sender(){return this._sender}set sender(value){this._sender=value;this.invalidate()}get recipients(){return this._recipients}set recipients(value){this._recipients=value;this.invalidate()}_langUpdated(e){console.log("plural-gender-element lang-updated lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(this.renderedEffectiveLang===this.effectiveLang||!this.renderedEffectiveLang&&"en"===this.effectiveLang){this.fire("local-dom-ready")}else{this.invalidate()}}_rendered(){console.log("plural-gender-element rendered lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(this.lang===this.effectiveLang){this.fire("local-dom-ready")}else{this.renderedEffectiveLang=this.effectiveLang;setTimeout(()=>{this.fire("local-dom-ready")},5e3)}}}customElements.define(PluralGenderElement.is,PluralGenderElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$9,_template:html$4`
    <p>
      <i18n-format id="compound-format-text" on-rendered="_rendered">
        <json-data>{
          "0": "You ({3}) gave no gifts.",
...
`,is:"plural-gender-element",behaviors:[BehaviorsStore.I18nBehavior],properties:{sender:{type:Object},recipients:{type:Array}},listeners:{"lang-updated":"_langUpdated"},_langUpdated:function(e){console.log("plural-gender-element lang-updated lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(e.composedPath()[0]===this){this.model=deepcopy(this.text.model)}if(this.renderedEffectiveLang===this.effectiveLang||""===this.renderedEffectiveLang&&"en"===this.effectiveLang){this.fire("local-dom-ready")}},_rendered:function(){console.log("plural-gender-element rendered lang = "+this.lang+" effectiveLang = "+this.effectiveLang);if(this.lang===this.effectiveLang){this.fire("local-dom-ready")}else{this.renderedEffectiveLang=this.effectiveLang}}})}break;}const bundledImportMeta$a={...import.meta,url:new URL("./simple-attribute-element/text-attribute-element.js",import.meta.url).href},$_documentContainer$5=document.createElement("template");$_documentContainer$5.innerHTML=`<i18n-attr-repo>
  <template id="custom">
...
</i18n-attr-repo>`;document.head.appendChild($_documentContainer$5.content);switch(syntax){default:case"element-binding":{class TextAttributeElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$a}render(){return html$4`${bind(this)}
    ...
    <span>text</span>
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];["custom-text-attr1","custom-text-attr2","custom-text-attr3","out-of-scope-attr","i18n-target","i18n-target2"].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}let updated=!1;switch(name){case"custom-text-attr1":this.customTextAttr1=newValue;updated=!0;break;case"custom-text-attr2":this.customTextAttr2=newValue;updated=!0;break;case"custom-text-attr3":this.customTextAttr3=newValue;updated=!0;break;case"i18n-target":this.i18nTarget=newValue;updated=!0;break;case"i18n-target2":this.i18nTarget2=newValue;updated=!0;break;default:break;}if(updated){this.invalidate()}}}customElements.define(TextAttributeElement.is,TextAttributeElement)}break;case"name-binding":{class TextAttributeElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$a}render(){return html$4`${bind("test-attribute-element",bundledImportMeta$a)}
    <span id="attr1">${this.customTextAttr1}</span>
    <span id="attr2">${this.customTextAttr2}</span>
    <span id="attr3">${this.customTextAttr3}</span>
    <span id="attr4">${this.outOfScopeAttr}</span>
    <span>text</span>
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];["custom-text-attr1","custom-text-attr2","custom-text-attr3","out-of-scope-attr","i18n-target","i18n-target2"].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}let updated=!1;switch(name){case"custom-text-attr1":this.customTextAttr1=newValue;updated=!0;break;case"custom-text-attr2":this.customTextAttr2=newValue;updated=!0;break;case"custom-text-attr3":this.customTextAttr3=newValue;updated=!0;break;case"i18n-target":this.i18nTarget=newValue;updated=!0;break;case"i18n-target2":this.i18nTarget2=newValue;updated=!0;break;default:break;}if(updated){this.invalidate()}}}customElements.define(TextAttributeElement.is,TextAttributeElement)}break;case"element-name-binding":{class TextAttributeElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$a}render(){return html$4`${bind(this,"test-attribute-element")}
    <span id="attr1">${this.customTextAttr1}</span>
    <span id="attr2">${this.customTextAttr2}</span>
    <span id="attr3">${this.customTextAttr3}</span>
    <span id="attr4">${this.outOfScopeAttr}</span>
    <span>text</span>
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];["custom-text-attr1","custom-text-attr2","custom-text-attr3","out-of-scope-attr","i18n-target","i18n-target2"].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}let updated=!1;switch(name){case"custom-text-attr1":this.customTextAttr1=newValue;updated=!0;break;case"custom-text-attr2":this.customTextAttr2=newValue;updated=!0;break;case"custom-text-attr3":this.customTextAttr3=newValue;updated=!0;break;case"i18n-target":this.i18nTarget=newValue;updated=!0;break;case"i18n-target2":this.i18nTarget2=newValue;updated=!0;break;default:break;}if(updated){this.invalidate()}}}customElements.define(TextAttributeElement.is,TextAttributeElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$a,_template:html$4`
...
`,is:"text-attribute-element",behaviors:[BehaviorsStore.I18nBehavior],properties:{customTextAttr1:{type:String,reflectToAttribute:!0},customTextAttr2:{type:String,reflectToAttribute:!0},customTextAttr3:{type:String,reflectToAttribute:!0},outOfScopeAttr:{type:String,reflectToAttribute:!0},i18nTarget:{type:String},i18nTarget2:{type:String}},listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(){this.model=deepcopy(this.text.model)}})}break;}const bundledImportMeta$b={...import.meta,url:new URL("./simple-attribute-element/simple-attribute-element.js",import.meta.url).href},$_documentContainer$6=document.createElement("template");$_documentContainer$6.innerHTML=`<template id="simple-attribute-element">
  ...
  </template>`;switch(syntax){default:case"element-binding":{class SimpleAttributeElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$b}render(){return html$4`${bind(this)}
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this._intervalId=window.setInterval(this._checkChartStatus.bind(this),1e3);setTimeout(function(){this.isPieChartRendered=!0;this.isColumnChartRendered=!0;window.clearInterval(this._intervalId);this.fire("local-dom-ready")}.bind(this),200);this.invalidate()}disconnectedCallback(){if(super.disconnectedCallback){super.disconnectedCallback()}}_checkChartStatus(){var pieChartInnerHtml=this.$["pie-chart"].$.chartdiv.innerHTML,columnChartInnerHtml=this.$["column-chart"].$.chartdiv.innerHTML,notLoaded=!1;if("Undefined chart type"===pieChartInnerHtml){this.isPieChartRendered=!0}if("Undefined chart type"===columnChartInnerHtml){this.isColumnChartRendered=!0}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}_pieChartRendered(){this.isPieChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}_columnChartRendered(){this.isColumnChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}}customElements.define(SimpleAttributeElement.is,SimpleAttributeElement)}break;case"name-binding":{class SimpleAttributeElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$b}render(){return html$4`${bind("simple-attribute-element",bundledImportMeta$b)}
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this._intervalId=window.setInterval(this._checkChartStatus.bind(this),1e3);setTimeout(function(){this.isPieChartRendered=!0;this.isColumnChartRendered=!0;window.clearInterval(this._intervalId);this.fire("local-dom-ready")}.bind(this),200);this.invalidate()}disconnectedCallback(){if(super.disconnectedCallback){super.disconnectedCallback()}}_checkChartStatus(){var pieChartInnerHtml=this.$["pie-chart"].$.chartdiv.innerHTML,columnChartInnerHtml=this.$["column-chart"].$.chartdiv.innerHTML,notLoaded=!1;if("Undefined chart type"===pieChartInnerHtml){this.isPieChartRendered=!0}if("Undefined chart type"===columnChartInnerHtml){this.isColumnChartRendered=!0}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}_pieChartRendered(){this.isPieChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}_columnChartRendered(){this.isColumnChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}}customElements.define(SimpleAttributeElement.is,SimpleAttributeElement)}break;case"element-name-binding":{class SimpleAttributeElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$b}render(){return html$4`${bind(this,"simple-attribute-element")}
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this._intervalId=window.setInterval(this._checkChartStatus.bind(this),1e3);setTimeout(function(){this.isPieChartRendered=!0;this.isColumnChartRendered=!0;window.clearInterval(this._intervalId);this.fire("local-dom-ready")}.bind(this),200);this.invalidate()}disconnectedCallback(){if(super.disconnectedCallback){super.disconnectedCallback()}}_checkChartStatus(){var pieChartInnerHtml=this.$["pie-chart"].$.chartdiv.innerHTML,columnChartInnerHtml=this.$["column-chart"].$.chartdiv.innerHTML,notLoaded=!1;if("Undefined chart type"===pieChartInnerHtml){this.isPieChartRendered=!0}if("Undefined chart type"===columnChartInnerHtml){this.isColumnChartRendered=!0}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}_pieChartRendered(){this.isPieChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}_columnChartRendered(){this.isColumnChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}}customElements.define(SimpleAttributeElement.is,SimpleAttributeElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$b,_template:html$4`
    <style attr="This is not extracted">
    google-chart {
      width: 300px;
    }
...
`,is:"simple-attribute-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated","pie-chart.google-chart-render":"_pieChartRendered","column-chart.google-chart-render":"_columnChartRendered"},ready:function(){},attached:function(){this._intervalId=window.setInterval(this._checkChartStatus.bind(this),1e3);setTimeout(function(){this.isPieChartRendered=!0;this.isColumnChartRendered=!0;window.clearInterval(this._intervalId);this.fire("local-dom-ready")}.bind(this),200)},_checkChartStatus:function(){var pieChartInnerHtml=this.$["pie-chart"].$.chartdiv.innerHTML,columnChartInnerHtml=this.$["column-chart"].$.chartdiv.innerHTML,notLoaded=!1;if("Undefined chart type"===pieChartInnerHtml){this.isPieChartRendered=!0}if("Undefined chart type"===columnChartInnerHtml){this.isColumnChartRendered=!0}if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}},_langUpdated:function(e){if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}},_pieChartRendered:function(){this.isPieChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}},_columnChartRendered:function(){this.isColumnChartRendered=!0;if(this.isPieChartRendered&&this.isColumnChartRendered){window.clearInterval(this._intervalId);this.fire("local-dom-ready")}}})}break;}const bundledImportMeta$c={...import.meta,url:new URL("./fallback-text-element/fallback-text-element.js",import.meta.url).href},$_documentContainer$7=document.createElement("template");$_documentContainer$7.innerHTML=`<template id="fallback-text-element">
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
  </template>`;switch(syntax){default:case"element-binding":{class FallbackTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$c}render(){return html$4`${bind(this)}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(FallbackTextElement.is,FallbackTextElement)}break;case"name-binding":{class FallbackTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$c}render(){return html$4`${bind("fallback-text-element",bundledImportMeta$c)}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(FallbackTextElement.is,FallbackTextElement)}break;case"element-name-binding":{class FallbackTextElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$c}render(){return html$4`${bind(this,"fallback-text-element")}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(FallbackTextElement.is,FallbackTextElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$c,_template:html$4`
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
...
`,is:"fallback-text-element",behaviors:[BehaviorsStore.I18nBehavior],listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(e){console.log(this.is,"lang-updated",e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}}})}break;}const bundledImportMeta$d={...import.meta,url:new URL("./compound-binding-element/compound-binding-element.js",import.meta.url).href},$_documentContainer$8=document.createElement("template");$_documentContainer$8.innerHTML=`<template id="compound-binding-element">
  ...
  </template>`;switch(syntax){default:case"element-binding":{class CompoundBindingElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$d}render(){return html$4`${bind(this)}
...
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}get param1(){return this._param1}set param1(value){this._param1=value;this.invalidate()}get param2(){return this._param2}set param2(value){this._param2=value;this.invalidate()}constructor(){super();this.param1="parameter 1";this.param2="parameter 2";this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(CompoundBindingElement.is,CompoundBindingElement)}break;case"name-binding":{class CompoundBindingElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$d}render(){return html$4`${bind("compound-binding-element",bundledImportMeta$d)}
    outermost text at the beginning with compound ${this.param1} and ${this.param2} variables
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1 with ${this.param1} and ${this.param2} variables</h1>
    ...
    <p id="paragraph">A paragraph with <b>id</b>, ${this.param1}, and ${this.param2} is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end with ${this.param1} and ${this.param2} variables
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}get param1(){return this._param1}set param1(value){this._param1=value;this.invalidate()}get param2(){return this._param2}set param2(value){this._param2=value;this.invalidate()}constructor(){super();this.param1="parameter 1";this.param2="parameter 2";this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(CompoundBindingElement.is,CompoundBindingElement)}break;case"element-name-binding":{class CompoundBindingElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$d}render(){return html$4`${bind(this,"compound-binding-element")}
    outermost text at the beginning with compound ${this.param1} and ${this.param2} variables
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1 with ${this.param1} and ${this.param2} variables</h1>
    ...
    <p id="paragraph">A paragraph with <b>id</b>, ${this.param1}, and ${this.param2} is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end with ${this.param1} and ${this.param2} variables
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}get param1(){return this._param1}set param1(value){this._param1=value;this.invalidate()}get param2(){return this._param2}set param2(value){this._param2=value;this.invalidate()}constructor(){super();this.param1="parameter 1";this.param2="parameter 2";this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(CompoundBindingElement.is,CompoundBindingElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$d,_template:html$4`
    outermost text at the beginning with compound {{param1}} and {{param2}} variables
    <div><div></div></div><!-- nested empty div -->
    <span id="whitespace"> &nbsp; </span>
    <h1>outermost header 1 with {{param1}} and {{param2}} variables</h1>
...
`,is:"compound-binding-element",behaviors:[BehaviorsStore.I18nBehavior],properties:{param1:{type:String,value:"parameter 1"},param2:{type:String,value:"parameter 2"}},listeners:{"lang-updated":"_langUpdated"},ready:function(){},attached:function(){},_langUpdated:function(e){console.log(this.is,"lang-updated",e.detail);if(dom(e).rootTarget===this){this.model=deepcopy(this.text.model)}}})}break;}const bundledImportMeta$e={...import.meta,url:new URL("./simple-text-id-element/simple-text-id-element.js",import.meta.url).href},$_documentContainer$9=document.createElement("template");$_documentContainer$9.innerHTML=`<template id="simple-text-id-element">
    ...
    outermost text at the end 
  </template>`;switch(syntax){default:case"element-binding":{class SimpleTextIdElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$e}render(){return html$4`${bind(this)}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span text-id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p text-id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(SimpleTextIdElement.is,SimpleTextIdElement)}break;case"name-binding":{class SimpleTextIdElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$e}render(){return html$4`${bind("simple-text-id-element",bundledImportMeta$e)}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span text-id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p text-id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(SimpleTextIdElement.is,SimpleTextIdElement)}break;case"element-name-binding":{class SimpleTextIdElement extends i18n(HTMLElement){static get importMeta(){return bundledImportMeta$e}render(){return html$4`${bind(this,"simple-text-id-element")}
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span text-id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
    ...
    <p text-id="paragraph">A paragraph with <b>id</b> is converted to <code>&lt;i18n-format&gt;</code>.</p>
    outermost text at the end 
`}static get observedAttributes(){let attributesSet=new Set,attributes=[];[].concat(super.observedAttributes).forEach(attr=>attributesSet.add(attr));attributesSet.forEach(attr=>attributes.push(attr));return attributes}constructor(){super();this.attachShadow({mode:"open"});let _langUpdatedBindThis=this._langUpdated.bind(this);this.addEventListener("lang-updated",_langUpdatedBindThis)}connectedCallback(){if(super.connectedCallback){super.connectedCallback()}this.invalidate()}_langUpdated(event){this.invalidate()}invalidate(){if(!this.needsRender){this.needsRender=!0;Promise.resolve().then(()=>{this.needsRender=!1;render(this.render(),this.shadowRoot)})}}attributeChangedCallback(name,oldValue,newValue){const handleOnlyBySelf=[];if(0<=!handleOnlyBySelf.indexOf(name)){if("function"===typeof super.attributeChangedCallback){super.attributeChangedCallback(name,oldValue,newValue)}}switch(name){default:break;}}}customElements.define(SimpleTextIdElement.is,SimpleTextIdElement)}break;case"legacy":{Polymer({importMeta:bundledImportMeta$e,_template:html$4`
    outermost text at the beginning 
    <div><div></div></div><!-- nested empty div -->
    <span text-id="whitespace"> &nbsp; </span>
    <h1>outermost header 1</h1>
