...
$_documentContainer.innerHTML = `<template id="fallback-text-element" basepath="fallback-text-element/" localizable-text="embedded">{{text.text}}<div><div></div></div><!-- nested empty div -->
...
</template><dom-module id="fallback-text-element" legacy="">
