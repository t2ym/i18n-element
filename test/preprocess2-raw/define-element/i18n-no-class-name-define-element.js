...
$_documentContainer.innerHTML = `<template id="i18n-no-class-name-define-element" basepath="define-element/" localizable-text="embedded">{{text.text}}<div><div></div></div><!-- nested empty div -->
