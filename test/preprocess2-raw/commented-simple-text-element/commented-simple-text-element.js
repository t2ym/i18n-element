...
$_documentContainer.innerHTML = `<template id="commented-simple-text-element" basepath="commented-simple-text-element/" localizable-text="embedded"><!-- comment -->{{text.text}}<!-- comment -->
...
</template><dom-module id="commented-simple-text-element" legacy="">
