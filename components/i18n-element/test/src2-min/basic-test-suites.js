...
suite('I18nElement with ' + 
  ...
  suite('disconnect i18n-dom-bind', function () {
    test('disconnect', function (done) {
      var p = document.querySelector('i18n-dom-bind#simple-text-dom-bind');
      var parent = p.parentNode;
      parent.removeChild(p);
      p.addEventListener('dom-change', function (e) {
        assert.equal(e.type, 'dom-change', true, 'i18n-dom-bind is rendered');
        done();
      })
