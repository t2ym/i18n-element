...
$_documentContainer.innerHTML = `<template id="i18n-no-class-name-but-is-define-element" basepath="define-element/" localizable-text="embedded">{{text.text}}<div><div></div></div><!-- nested empty div -->
...
case 'thin':
  {
    Define = class extends BaseElements.I18nElement {
      static get is () { return 'i18n-no-class-name-but-is-define-element'; }
    };
  }
  break;
}
