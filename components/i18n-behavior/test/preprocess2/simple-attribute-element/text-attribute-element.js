...
</i18n-attr-repo><template id="text-attribute-element" text-attr="custom-text-attr1 custom-text-attr3" basepath="simple-attribute-element/" localizable-text="embedded">
...
</template><dom-module id="text-attribute-element" legacy="">
